...
import TopicCardSlide from "./TopicCardSlide3";
...
export default function SubjectPager({ subjectItem }) {
  ...
  // ✅ Global zoom so it stays consistent across ALL pages
  ...
  useEffect(() => {
    ...
    setZoom(1); // ✅ new subject starts at normal size
  ...
  useEffect(() => {
    ...
    const onWheel = (e) => {
      // ✅ If a child already handled it (zoom), do nothing
      if (e.defaultPrevented) return;

      // ✅ Never page on Ctrl/Cmd+wheel (that’s reserved for zoom in the card)
