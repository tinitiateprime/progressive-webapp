  ...
  return (
    ...
    >
      <ReactMarkdown
        ...
        components={{
          h1: (props) => <h1 className="mt-[18px] mb-[10px] leading-[1.25] font-[800]" {...props} />,
          h2: (props) => <h2 className="mt-[18px] mb-[10px] leading-[1.25] font-[800]" {...props} />,
          h3: (props) => <h3 className="mt-[18px] mb-[10px] leading-[1.25] font-[800]" {...props} />,
              ...
              <div className="relative">
                ...
                <pre
                  className={[
                    ...
                    "[touch-action:pan-x]", // ✅ makes horizontal swipe work inside code blocks
